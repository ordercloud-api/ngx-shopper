...
import { OcMeService, ListBuyerProduct, OcBuyerService, Buyer } from '@ordercloud/angular-sdk';
...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.featuredProducts$ = this.ocMeService.ListProducts({ filters: <any>{ 'xp.Featured': true } });
  ...
  GetBuyerOrg(): Observable<Buyer> {
    ...
    return this.ocBuyerService.List().pipe(
