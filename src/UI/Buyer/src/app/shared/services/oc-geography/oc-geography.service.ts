...
import { StateDefinition, CountryDefinition } from './oc-geography.models';
...
export class OcGeographyService {
  ...
  getStates(): StateDefinition[] {
    return [
      ...
      { 'label': 'Armed Forces Americas (AA)', 'abbreviation': 'AA', 'country': 'US' },
      { 'label': 'Armed Forces Africa/Canada/Europe/Middle East (AE)', 'abbreviation': 'AE', 'country': 'US' },
      { 'label': 'Armed Forces Pacific (AP)', 'abbreviation': 'AP', 'country': 'US' },
      { 'label': 'American Samoa', 'abbreviation': 'AS', 'country': 'US' },
      { 'label': 'Federated States of Micronesia', 'abbreviation': 'FM', 'country': 'US' },
